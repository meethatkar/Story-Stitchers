    ...
    [...hintDivs].forEach((hint) => {
        hint.addEventListener("click", () => {
            ...
            if (hint.tagName == "SPAN") {
                if (/\d/.test(hint.textContent.slice(0, 3))) {
                    ...
                    window.innerWidth<765 ? hint.classList.add("hint-clicked"):hint.classList.add("hint-clicked-desktop");
        ...
        document.querySelector("#reset-btn").addEventListener("click", () => {
            if (/\d/.test(hint.textContent.slice(0, 3))) {
                ...
                // console.log(hint.textContent.slice(3,hint.textContent.length));
                if(hint.tagName == "SPAN" ){
                    window.innerWidth<765 ? hint.classList.remove("hint-clicked") : hint.classList.remove("hint-clicked-desktop");
                    window.innerWidth<765 ? hint.classList.add("hint-btn") : hint.classList.add("hint-desktop");
                }
...
if (window.innerWidth > 765) {
    ...
    document.querySelector("#hint-text h1").classList.add("text-stroke-css");
    let i = document.querySelectorAll("#hint-text i");
    i.forEach((i)=>{
        i.classList.add("mini-text-stroke-css");
    });
}
